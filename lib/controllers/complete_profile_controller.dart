...
class CompleteProfileController extends GetxController {
  ...
  Future<void> updateProfileRepo() async {
    ...
    var response = await ApiService.multipartRequest(url: "${AppUrls.users}/${PrefsHelper.userId}", body: body, imagePath: imagePath, header: header);
    ...
    if(response.statusCode == 200){
      ...
      Utils.snackBarSuccessMessage("Success:", "Your account information updated successfully");
      Get.back();
    }else{

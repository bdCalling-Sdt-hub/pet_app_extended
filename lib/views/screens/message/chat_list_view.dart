          ...
          child: Obx(() {
            return Column(
              children: [
                ...
                /// ======================== Search List ======================
                controller.filteredChatUsersList.isNotEmpty &&
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      controller.getChatUsers(status: "active");
                            ...
                            controller.isInformation.value
                                ? controller.isLoading
                                    ...
                                    : controller.chatActiveUsersList.isEmpty
                                        ? const SizedBox(
                                            height: 200, child: NoData())
                                        : Expanded(
                                            child: ListView.builder(
                                              itemCount: controller
                                                  .chatActiveUsersList.length,
                                              itemBuilder: (context, index) {
                                                var chatUserDetails = controller
                                                    .chatActiveUsersList[index];
                                                return GestureDetector(
                                                  onTap: () {
                                                    controller.chatId =
                                                        chatUserDetails.id;
                                                    controller
                                                        .createOrGetMessageRepo(
                                                            chatId:
                                                                chatUserDetails
                                                                    .id);
                                ...
                                : controller.isArchivedLoading
                                    ? SizedBox(
                                        height: 300.h,
                                        child: const CustomLoader())
                                    : controller.chatArchivedUsersList.isEmpty
                                        ? const SizedBox(
                                            height: 200, child: NoData())
                                        : Expanded(
                                            child: ListView.builder(
                                              itemCount: controller
                                                  .chatArchivedUsersList.length,
                                              itemBuilder: (context, index) {
                                                var chatUserDetails = controller
                                                        .chatArchivedUsersList[
                                                    index];
                                                return GestureDetector(
                                                  onTap: () {
                                                    selectedIndex = index;

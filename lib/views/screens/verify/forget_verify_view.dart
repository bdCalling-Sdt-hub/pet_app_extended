        ...
        return Column(
          children: [
            Row(
              ...
              children: [
                Text("Give",style:  h3.copyWith(fontSize: 30)),
                sw5,
                Text("Verification",style:  h3.copyWith(fontSize: 30,color: AppColors.mainColor),textAlign: TextAlign.center,),
                sw5,
            ...
            forgotController.isLoading
                ? const CustomLoader()
                : CustomButton(onTap: () => forgotController.verifyForgotOtpRepo(),title: "Verify", width: Get.width, color: AppColors.mainColor),
            24.height
          ],
        );
      },)

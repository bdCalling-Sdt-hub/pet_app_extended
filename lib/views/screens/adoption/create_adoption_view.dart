        ...
        body: GetBuilder<MenuDataController>(
          builder: (controller) {
            if(CreateAdoptionView.isUpdate){
              controller.nameController.text = CreateAdoptionView.petListDetails.petName;
              controller.ageController.text = CreateAdoptionView.petListDetails.age;
              controller.colorController.text = CreateAdoptionView.petListDetails.color;
              controller.weightController.text = CreateAdoptionView.petListDetails.weight;
              controller.addressController.text = CreateAdoptionView.petListDetails.address;
              controller.microchipNumberController.text = CreateAdoptionView.petListDetails.microchipNumber;
              controller.descriptionController.text = CreateAdoptionView.petListDetails.description;
              controller.healthConditionController.text = CreateAdoptionView.petListDetails.healthCondition;
              controller.neuterController.text = CreateAdoptionView.petListDetails.neuter;
              controller.vaccineController.text = CreateAdoptionView.petListDetails.vaccine;
              controller.temperController.text = CreateAdoptionView.petListDetails.temper;
              controller.activityLevelController.text = CreateAdoptionView.petListDetails.activityLevel;
              controller.behaviorController.text = CreateAdoptionView.petListDetails.behavior;
              controller.specialNeedsController.text = CreateAdoptionView.petListDetails.specialNeeds;
              controller.petHistoryController.text = CreateAdoptionView.petListDetails.petHistory;
              controller.contactInfoController.text = CreateAdoptionView.petListDetails.contactInformation;
            }
              ...
              child: SingleChildScrollView(
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): 20.height,
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): petSelectionDropDown(controller),
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): 12.height,
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): controller.image == null
                          ? GestureDetector(
                      ...
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): 12.height,
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): CustomText(text: "Breed".tr, fontWeight: FontWeight.w600, bottom: 8,),
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): breedSelectionDropDown(controller),
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): 8.height,
                      ...
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): 12.height,
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): CustomText(text: "Sex".tr, fontWeight: FontWeight.w600, bottom: 8),
                      CreateAdoptionView.isUpdate? SizedBox.shrink(): genderSelectionDropDown(controller),
                      12.height,
                      CustomTextFormField(
                        title: "Color".tr,
                      ...
                      CustomTextFormField(
                        ...
                        hintText: "Write about your pet’s health condition".tr,
                        validator: ValidatorHelper.validator,
                        horizontalPadding: 0,
                      ...
                      CustomTextFormField(
                        ...
                        hintText: "Is spaying/neutering safe for my pet?".tr,
                        validator: ValidatorHelper.validator,
                        horizontalPadding: 0,
                      ...
                      CustomTextFormField(
                        title: "Vaccine".tr,
                        hintText: "Is your pet vaccinated?".tr,
                        validator: ValidatorHelper.validator,
                        horizontalPadding: 0,
                      ...
                      CustomTextFormField(
                        title: "Temper".tr,
                        hintText: "Is your pet calm or energetic?".tr,
                        validator: ValidatorHelper.validator,
                        horizontalPadding: 0,
                      ...
                      CustomTextFormField(
                        ...
                        hintText: "What is your pet's activity level?".tr,
                        validator: ValidatorHelper.validator,
                        horizontalPadding: 0,
                      ...
                      CustomTextFormField(
                        ...
                        hintText: "Is the pet good with kids and other animals?".tr,
                        validator: ValidatorHelper.validator,
                        horizontalPadding: 0,
                      ...
                      CustomTextFormField(
                        ...
                        hintText: "Does your pet have any special needs?".tr,
                        validator: ValidatorHelper.validator,
                        horizontalPadding: 0,
                      ...
                      CustomTextFormField(
                        ...
                        hintText: "Previous medical issues?".tr,
                        validator: ValidatorHelper.validator,
                        horizontalPadding: 0,
                      ...
                      CustomTextFormField(
                        ...
                        hintText: "Need adoption details, please provide.".tr,
                        validator: ValidatorHelper.validator,
                        horizontalPadding: 0,

...
import 'package:felpus/app/modules/menu/views/create_found_pet_view.dart';
import 'package:felpus/app/modules/menu/views/create_lost_pet_view.dart';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          sh5,
                          GestureDetector(
                            onTap: () => Get.to(() => CreateLostPetView()),
                            child: Container(
                              height: 50,
                              width: 150,
                              decoration: BoxDecoration(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          sh5,
                          GestureDetector(
                            onTap: () => Get.to(() => CreateFoundPetView()),
                            child: Container(
                              height: 50,
                              width: 150,
                              decoration: BoxDecoration(

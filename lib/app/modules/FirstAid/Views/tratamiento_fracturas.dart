      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const CustomTitleText(titleText: "7. Buscar atención profesional:", leftPadding: 8, isDecoration: false, fontSize: 16,),
            DotRow(text: "Es fundamental trasladar a la víctima al centro veterinario más cercano lo antes posible."),
            DotRow(text: "El personal veterinario evaluará la fractura, determinará el tratamiento adecuado y podrá realizar la reducción y/o inmovilización definitiva de la zona lesionada."),
            const CustomTitleText(titleText: "Recomendaciones adicionales:", isDecoration: false),
            DotRow(text: "No intentar mover fragmentos óseos que hayan atravesado la piel."),
            DotRow(text: "Evitar aplicar hielo directamente sobre la piel."),
            DotRow(text: "No administrar medicamentos para el dolor sin antes consultar con un veterinario."),
            DotRow(text: "Mantener a la mascota tranquila y cómoda durante el traslado al centro veterinario."),
            20.height,
          ],
        ),
      ),

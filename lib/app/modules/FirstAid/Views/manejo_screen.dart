  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            CustomText(text: "Pasos a seguir para manejar convulsiones en perros y gatos:"),
            CustomTitleText(titleText: "Durante la convulsión:", textAlignment: Alignment.center, isDecoration: false,),
            Align(
